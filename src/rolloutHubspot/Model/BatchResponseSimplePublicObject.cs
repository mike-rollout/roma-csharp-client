...
namespace rolloutHubspot.Model
{
    ...
    public partial class BatchResponseSimplePublicObject : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public BatchResponseSimplePublicObject(DateTime completedAt = default(DateTime), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>), List<SimplePublicObject> results = default(List<SimplePublicObject>), StatusEnum status = default(StatusEnum))
        {
